...
$consulta = "SELECT * FROM requisicaopedidos WHERE protetico_resp = '$logado' AND disponibilidade = 'Pedido Enviado'";
                ...
                <table id="tabelaCustom">
                    ...
                    <tr>
                       ...
                       <form action="recusarPedido.php" method="get">
                        ...
                        <td><button type="submit" onclick='deletado_Sucesso()' class='btn btn-danger'>Recusar Pedido</button></td>
                        </form>
                         <!-- Modal -->
                           ...
                           <div class="modal-dialog">
                             ...
                             <div class="modal-content">
                               ...
                               <div class="modal-body">
                                <form action="trabalhoAceito.php" method="get">
                                    <div class="row">
                                        <div class="col-md-4">
